...
from django.contrib.auth.mixins import LoginRequiredMixin #PARA LIMITAR EL ACCESO

#PARA VISTAS COMUNES (LIMITAR ACCESO)
...
def editar_mascota(request, id):
    ...
    return render(request, 'avanzado/editar_mascota.html', 
                  {'formulario' : formulario, 'mascota' : mascota}) 
